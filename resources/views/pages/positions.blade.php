<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="text-2xl font-light text-gray-500">{{ __('Positions') }}</span></h2>
                    ...
                    <table class="w-full mb-5">
                        ...
                        @foreach($positions as $position)
                            <tr class="bg-gray-50 hover:bg-gray-100">
                                ...
                                <td class="p-3 text-sm text-gray-700">
                                    <div class="">
                                        <a href="{{ route('department.edit', ['department_id' => $position->department->id]) }}" class="text-sm text-gray-800 hover:text-blue-500 py-2">
                                ...
                                <td class="p-3 text-sm text-gray-700">
                                    <div class="">
                                        <a href="{{ route('position.edit', ['position_id' => $position->id]) }}" class="text-sm text-gray-800 hover:text-blue-500 py-2">
                                            {{ $position->title }}
                                        </a>
                                    </div>
                                </td>
